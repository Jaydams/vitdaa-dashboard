...
export function InventoryTransactionsList({
  ...
  const generateCSVContent = (transactions: InventoryTransaction[]) => {
    const headers = [
      "Date",
      "Item",
      "Transaction Type",
    ...
    const rows = transactions.map((transaction) => [
      ...
      `${transaction.quantity} ${transaction.item?.unit_of_measure || ""}`,
      `₦${transaction.unit_cost}`,
      `₦${transaction.total_cost}`,
      transaction.previous_stock.toString(),
      transaction.new_stock.toString(),
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            onClick={() => {
              ...
              downloadCSV(csvContent, "inventory-transactions.csv");
            }}
          >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Showing {(page - 1) * 10 + 1} to {Math.min(page * 10, count)} of{" "}
            {count} transactions
          </CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Badge
                          variant={getTransactionTypeColor(
                      ...
                      <div className="flex items-center gap-4 text-sm text-muted-foreground">
                        ...
                        <span>Cost: ₦{transaction.unit_cost}</span>
                        <span>Total: ₦{transaction.total_cost}</span>
                        <span>
                          Stock: {transaction.previous_stock} →{" "}
