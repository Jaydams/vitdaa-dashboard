      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            {Math.min(page * 10, alertsData.count)} of {alertsData.count} alerts
          </CardDescription>
        </CardHeader>
        <CardContent>
                    ...
                    <div className="flex items-start gap-3 flex-1">
                      <div
                        className={`p-2 rounded-full ${
                          alert.is_resolved ? "bg-green-100" : "bg-orange-100"
                        }`}
                      >
                        {alert.is_resolved ? (
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-xs text-muted-foreground">
                          ...
                          {alert.item && (
                            <span>
                              Current Stock: {alert.item.current_stock}{" "}
                              {alert.item.unit_of_measure}
                            </span>
                          )}
                        </div>
                      </div>
