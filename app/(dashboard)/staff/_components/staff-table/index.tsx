...
import { fetchStaffWithSessions } from "@/data/staff";
...
export default function AllStaff({ perPage = 10, refetchTrigger = 0 }: Props) {
  ...
  const {
    ...
    queryKey: ["staff", page, refetchTrigger], // Include refetchTrigger in query key
    queryFn: () => fetchStaffWithSessions({ page, perPage }),
